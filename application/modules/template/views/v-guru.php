            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo site_url('guru/profil') ?>" class="nav-link">
                                <i class="icon-user"></i>
                                <span class="title">Profil Guru</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo site_url('guru/wakel') ?>" class="nav-link">
                                <i class="icon-users"></i>
                                <span class="title">Guru Wali Kelas</span>
                            </a>
                        </li>
                        <li class="nav-item start ">
                            <a href="#" class="nav-link">
                                <i class="icon-note"></i>
                                <span class="title">Isi Nilai</span>
                            </a>
                        </li>
                        <li class="nav-item start ">
                            <a href="#" class="nav-link">

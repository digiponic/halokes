                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user dropdown-dark">
                                ...
                                <ul class="dropdown-menu dropdown-menu-default">
                                    <li>
                                        <a><i class="icon-user"></i> Orang Tua</a>
                                    </li>
                                    <li class="divider"></li>
                                    <li>
            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <li class="nav-item start ">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo site_url('ortu/akademik') ?>/<?php echo $user->nisn; ?>"  class="nav-link">
                                <i class="icon-graph"></i>
                                <span class="title">Ringkasan</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo site_url('ortu/kehadiran') ?>/<?php echo $user->nisn; ?>" class="nav-link">
                                <i class="icon-check"></i>
                                <span class="title">Data Kehadiran</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo site_url('ortu/rapor') ?>/<?php echo $user->nisn; ?>" class="nav-link">
                                <i class="icon-book-open"></i>
                                <span class="title">Rapor Siswa</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo site_url('ortu/pengumuman') ?>/<?php echo $user->nisn; ?>" class="nav-link">
                        ...
                        <li class="nav-item start ">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item">
                                    <a href="<?php echo site_url('ortu/prestasi_internal') ?>/<?php echo $user->nisn; ?>" class="nav-link ">
                                        <i class="icon-badge"></i>
                                        <span class="title">Prestasi Internal</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                                    <a href="<?php echo site_url('ortu/prestasi_external') ?>/<?php echo $user->nisn; ?>" class="nav-link ">
                                        <i class="icon-badge"></i>
                                        <span class="title">Prestasi Eksternal</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo site_url('ortu/sanksi') ?>/<?php echo $user->nisn; ?>" class="nav-link">
                                <i class="icon-ban"></i>

            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo site_url('siswa/ringkasan') ?>" class="nav-link">
                                <i class="icon-graph"></i>
                                <span class="title">Ringkasan</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo site_url('siswa/kehadiran') ?>" class="nav-link">
                                <i class="icon-check"></i>
                                <span class="title">Data Kehadiran</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo site_url('siswa/rapor') ?>" class="nav-link">
                                <i class="icon-book-open"></i>
                                <span class="title">Rapor Siswa</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo site_url('siswa/pengumuman') ?>" class="nav-link">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    <a href="#" class="nav-link ">
                                        ...
                                        <span class="title">Keikutsertaan</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
